...
const DINOS: Dino[] = [
  {
    id: 'trex', ko: '티라노사우루스', en: 'Tyrannosaurus Rex', seed: 1001,
  ...
  {
    id: 'triceratops', ko: '트리케라톱스', en: 'Triceratops', seed: 1002,
  ...
  {
    id: 'brachiosaurus', ko: '브라키오사우루스', en: 'Brachiosaurus', seed: 1003,
  ...
  {
    id: 'velociraptor', ko: '벨로키랍토르', en: 'Velociraptor', seed: 1004,
  ...
  {
    id: 'stegosaurus', ko: '스테고사우루스', en: 'Stegosaurus', seed: 1005,
  ...
  {
    id: 'pteranodon', ko: '프테라노돈', en: 'Pteranodon', seed: 1006,
  ...
  {
    id: 'ankylosaurus', ko: '안킬로사우루스', en: 'Ankylosaurus', seed: 1007,
  ...
  {
    id: 'spinosaurus', ko: '스피노사우루스', en: 'Spinosaurus', seed: 1008,
  ...
  {
    id: 'diplodocus', ko: '디플로도쿠스', en: 'Diplodocus', seed: 1009,
  ...
  {
    id: 'parasaurolophus', ko: '파라사우롤로푸스', en: 'Parasaurolophus', seed: 1010,
  ...
  {
    id: 'allosaurus', ko: '알로사우루스', en: 'Allosaurus', seed: 1011,
  ...
  {
    id: 'pachycephalosaurus', ko: '파키케팔로사우루스', en: 'Pachycephalosaurus', seed: 1012,
  ...
  {
    id: 'iguanodon', ko: '이구아노돈', en: 'Iguanodon', seed: 1013,
  ...
  {
    id: 'therizinosaurus', ko: '테리지노사우루스', en: 'Therizinosaurus', seed: 1014,
  ...
  {
    id: 'carnotaurus', ko: '카르노타우루스', en: 'Carnotaurus', seed: 1015,
...
function getDinoImg(dino: Dino) {
  const prompt = encodeURIComponent(
    `${dino.en} dinosaur, full body side view, white background, colorful encyclopedia illustration, detailed natural history, photorealistic`
  );
  return `https://image.pollinations.ai/prompt/${prompt}?width=512&height=400&seed=${dino.seed}&nologo=true&model=flux`;
}
      ...
      {selected && (
        <div className="fixed inset-0 bg-black/60 z-50 flex items-end sm:items-center justify-center"
          ...
          <div className="bg-white w-full max-w-lg rounded-t-3xl sm:rounded-3xl max-h-[92vh] overflow-y-auto relative"
            ...
            <div className="w-full h-64 bg-white flex items-center justify-center overflow-hidden rounded-t-3xl px-4 pt-4">
              {!imgErr[selected.id] ? (
                <img src={getDinoImg(selected)} alt={selected.ko} className="w-full h-full object-contain" />
              ) : (
